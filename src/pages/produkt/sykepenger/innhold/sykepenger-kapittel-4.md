...
#### Nye søknader eller forlengelser
...
==Nødvendig med «Reise» på alle items over?==
...
{{ microcard({ text: 'Dagpenger', dot: 'bg-green-400' }) }}
...
{{ microcard({ text: 'Friskmelding til arbeidsformidling', dot: 'bg-lightgreen-400' }) }}
...
#### Kan du få både sykepenger og dagpenger?

For å ha rett til [dagpenger](#) må du være reell arbeidssøker. Vi regner deg som reell arbeidssøker når du er i stand til å jobbe i minst halv stilling. Hvis du er sykmeldt mer enn 50 prosent, vil du ikke være i stand til å jobbe i halv stilling, og du fyller dermed ikke kravene for å få dagpenger. Du kan likevel ha rett til sykepenger for de prosentene du er sykmeldt.

Hvis du er 50 prosent sykmeldt eller mindre, kan du ha rett til sykepenger i kombinasjon med dagpenger.

#### Må du sende meldekort når du er sykmeldt?

Hvis du er delvis sykmeldt og skal kombinere sykepenger og dagpenger, må du [sende meldekort](#).
