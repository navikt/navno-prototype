module.exports = {
  situationList: [
    ...
    },
    {
      title: "Søker jobb",
      ingress:
        "Jobbsøkertips og ledige jobber når du er arbeidssøker eller ønsker å skifte jobb.",
      category: "Dette kan du ha rett til",
    },
    {
    ...
    {
      title: "Er utenlandsk arbeidstaker i Norge",
      ingress: "Om hvilke trygderegler som gjelder når du skal jobbe i Norge.",
      category: "Dette kan du ha rett til",
    },
    {
      title: "Er berørt av krigen i Ukraina ",
      ingress: "Du kan få hjelp fra NAV når du er flyktning.",
      category: "Dette kan du ha rett til",
    },
    {
      title: "Skal jobbe i utlandet",
      ingress:
        "Om hvilke trygderegler som gjelder når du skal jobbe i utlandet.",
      category: "Dette kan du ha rett til",
    },
    {
      title: "Skal oppholde deg i utlandet",
      ingress:
        "Om hvilke trygderegler som gjelder når du skal oppholde deg i utlandet.",
      category: "Dette kan du ha rett til",
    },
  ],
};
