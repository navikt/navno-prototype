module.exports = {
  ...
  products: [
    ...
    { title: "Avklaring", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Bilstønad", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Førerhund", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Honnørkort", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Irislinse", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    { title: "Jobbklubb", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Meldekort", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Mentor", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Oppfølging", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    { title: "Opplæring", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Parykk", icon: "/src/_includes/svg/pictograms/parykk.svg" },
    {
    ...
    { title: "Sykkel", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Teleslynge", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Ventelønn", icon: "/src/_includes/svg/pictograms/neutral.svg" },
    {
    ...
    { title: "Øyeprotese", icon: "/src/_includes/svg/pictograms/neutral.svg" },
  ],
};
