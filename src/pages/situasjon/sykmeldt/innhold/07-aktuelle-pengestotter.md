...
<div class="grid gap-3 text-left sm:gap-6 sm:grid-cols-2" style="--pictogram: var(--color-blue-100);">
  ...
  <div class="relative border rounded-lg sm:aspect-square border-slate-300 has-[a:hover]:bg-blue-50 grid w-full gap-3 px-5 py-4 xs:flex xs:gap-6 xs:items-start">
